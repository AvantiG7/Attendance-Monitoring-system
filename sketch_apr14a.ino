...
const char *GScriptId = "AKfycby3X7NOEtOtRpELalRlWuAtU7V7uDoOHAVEHADKfIG0wHFxd_6TJFGSs3OPxi5WE9Hbtg";
//---------------------------------------------------------------------------------------------------------
// Enter network credentials:
const char* ssid     = "aashish's S24";
const char* password = "aashish1";
//---------------------------------------------------------------------------------------------------------
